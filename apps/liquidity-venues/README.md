...
- **UniswapV3** — Swaps tokens on Uniswap V3.
- **UniswapV4** — Swaps tokens on Uniswap V4.
- **1inch** — Swaps tokens via the 1inch swap aggregator (requires a 1inch API Key).
- **Pendle** — Swaps and redeems Pendle PT tokens.
- **Midas** — Redeems Midas tokens.
- **LiquidSwap** — Swaps tokens on LiquidSwap (HyperEVM).
